...
public class EventoManagedBean implements Serializable {
    ...
    public ArrayList<Evento> getEventos() {
        ...
        ev.setCaminhoImagem("metallica.jpg");
        ev.setCaminhoImagemBack("metallica_back.jpg");
        ...
        ev2.setCaminhoImagem("cpm22.jpg");
        ev2.setCaminhoImagemBack("cpm22_back.jpg");
        ...
        ev3.setCaminhoImagem("natiruts.jpg");
        ev3.setCaminhoImagemBack("natiruts_back.jpg");
        ...
        ev4.setCaminhoImagem("guns.jpg");
        ev4.setCaminhoImagemBack("guns_back.jpg");
        ...
        ev5.setCaminhoImagem("lolla.jpg");
        ev5.setCaminhoImagemBack("lolla_back.jpg");
